                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${cartItemList}" var="cartItem"> 
                        ...
                        <form action="<c:url value="/updateCartItem/${cartItem.cartItemId}"/>" method="post">
                            <td><img src="<c:url value="/resources/images/${cartItem.productId}.jpg"/>" width="50" height="100"/> </td>
                            ...
                            <td class="text-right">
                            <a href="<c:url value="/deleteCartItem/${cartItem.cartItemId}"/>" class="btn btn-sm btn-danger"><i class="fa fa-trash">Delete</i> </a>
                            <input type="submit" value="Update" class="btn btn-sm btn-info"/></td>
                            </form>
                        </tr>
                        </c:forEach>
                        <tr>
